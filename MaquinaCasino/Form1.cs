...
namespace MaquinaCasino
{
    public partial class Form1 : Form
    {
        ...
        Image i7 = Image.FromFile("C:\\Users\\WALDO\\Documents\\UNIVERSIDAD\\4to Semestre\\Seminario de Algoritmia\\MaquinaCasino\\7.jpg");
        Image diamante = Image.FromFile("C:\\Users\\WALDO\\Documents\\UNIVERSIDAD\\4to Semestre\\Seminario de Algoritmia\\MaquinaCasino\\diamante.jpg");
        Image corazon = Image.FromFile("C:\\Users\\WALDO\\Documents\\UNIVERSIDAD\\4to Semestre\\Seminario de Algoritmia\\MaquinaCasino\\corazon.jpg");
        Image dados = Image.FromFile("C:\\Users\\WALDO\\Documents\\UNIVERSIDAD\\4to Semestre\\Seminario de Algoritmia\\MaquinaCasino\\dados.jpg");
        ...
        public void Premios() // Función para el control de los premios, en cada opción se suman los créditos y se muestra un mensaje en pantalla que avisa sí hubo premio
        {
            ...
            {
                MessageBox.Show("No has ganado :(","UPSSS");
            }
        } // Fin Premios()
        ...
        private void ButtonJugar_Click(object sender, EventArgs e) // Evento de Click en el botón Jugar
        {
            ...
            if (creditos >= 7) // Sí la cantidad de créditos es mayor o igual a 7
            {
                ...
                for (int i = 0; i < 100; i++) // Ciclo de cambio de imágenes por grupo de 3
                {
                    ...
                    else if (cont == 4)
                    {
                        ...
                        pictureBox_3.Image = corazon;
                        cont = 1; // Asignamos 1 a cont para iniciar con el ciclo de nuevo
                    }
            ...
            {
                MessageBox.Show("No cuentas con suficientes creditos","[*ADVERTENCIA*]");
            }//Si no tiene los creitos para jugar lo muestra
        }

        int creditosStock = 0; // Variable para guardar los créditos seleccionados que aún no han sido ingresados
       ...
       private void ButtonAggCdt_Click(object sender, EventArgs e) // Evento de Click en el botón Agregar Crédito
        ...
        private void ButtonDarCambio_Click(object sender, EventArgs e) // Evento Click del botón Dar Cambio
        {
            if (creditos > 0) // Sí hay créditos de los cuales dar cambio
            {
                ...
                if (checkBox_2.Checked == false) // Si la casiila de la moneda de 2 está activa
                {
